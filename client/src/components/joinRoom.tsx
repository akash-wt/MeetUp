...
const JoinRoom = () => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center p-4 mt-20">
            <div className="bg-gray-800 rounded-xl p-8 max-w-md w-full shadow-2xl">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-gray-400">Connect with others through high-quality video calls</p>
                </div>
